...
published: true
link: https://amzn.to/3XzpEfC # Generic Amazon link for feminist books
    ...
    <main class="row s-styles">
        <section id="styles" class="column large-full">
            ...
            <div class="entry__content">
                ...
                {% assign book_image_filename = "feminism-is-for-everybody.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/3Xz6A19" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "/bell-hooks-essential-reads-feminism-is-for-everybody-will-to-change" %}
                ...
                {% assign book_image_filename = "feminine-mystique.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/40YTFsj" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "/feminine-mystique-betty-friedan-impact" %}
                ...
                {% assign book_author = "bell hooks" %}
                {% assign book_image_filename = "aint-i-a-woman.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/3ciW6u5" %} <!-- Example link -->
                ...
                {% assign book_image_filename = "hood-feminism.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/3XzpEfC" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "#" %} <!-- Placeholder for future post on Hood Feminism -->
                {% assign book_internal_link_text = "Understanding Hood Feminism (Coming Soon)" %}
                {{ book_entry }}

                {% assign book_title = "Bad Feminist" %}
                {% assign book_author = "Roxane Gay" %}
                {% assign book_image_filename = "bad-feminist.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/2VqThJ4" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "#" %} <!-- Placeholder for future post on Bad Feminist -->
                {% assign book_internal_link_text = "Why 'Bad Feminist' Resonates (Coming Soon)" %}
                {{ book_entry }}

                {% assign book_title = "Sister Outsider: Essays and Speeches" %}
                {% assign book_author = "Audre Lorde" %}
                {% assign book_image_filename = "sister-outsider.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/3fI3XqT" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "#" %} <!-- Placeholder for future post on Audre Lorde -->
                {% assign book_internal_link_text = "The Powerful Words of Audre Lorde (Coming Soon)" %}
                {{ book_entry }}
                ...
                {% assign book_image_filename = "black-feminist-thought.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/3AqCf2S" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "#" %} <!-- Placeholder for future post on Black Feminist Thought -->
                {% assign book_internal_link_text = "Understanding Black Feminist Thought (Coming Soon)" %}
                {{ book_entry }}

                {% assign book_title = "We Should All Be Feminists" %}
                {% assign book_author = "Chimamanda Ngozi Adichie" %}
                {% assign book_image_filename = "we-should-all-be-feminists.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/3Xz6A19" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "#" %} <!-- Placeholder for future post on Adichie -->
                {% assign book_internal_link_text = "Adichie's Call to Action (Coming Soon)" %}
                {{ book_entry }}

                {% assign book_title = "The Beauty Myth: How Images of Beauty Are Used Against Women" %}
                {% assign book_author = "Naomi Wolf" %}
                {% assign book_image_filename = "beauty-myth.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/39sXpqs" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "#" %} <!-- Placeholder for future post on The Beauty Myth -->
                {% assign book_internal_link_text = "Deconstructing The Beauty Myth (Coming Soon)" %}
                {{ book_entry }}

                {% assign book_title = "Invisible Women: Data Bias in a World Designed for Men" %}
                {% assign book_author = "Caroline Criado Perez" %}
                {% assign book_image_filename = "invisible-women.jpg" %} <!-- Placeholder image -->
                {% assign book_amazon_link = "https://amzn.to/3xW3LzK" %} <!-- Example link -->
                ...
                {% assign book_internal_link_url = "#" %} <!-- Placeholder for a future post or a broader discussion on systemic sexism -->
                {% assign book_internal_link_text = "The Data Behind Sexism (Coming Soon)" %}
                {{ book_entry }}
                ...
                <ul>
                    ...
                    <li><a href="#">Understanding Intersectionality: Essential Feminist Books</a> (Placeholder)</li>
                </ul>
            </div>
        </section>
    </main>
