...
image: best-feminist-books-guide.jpg # Local placeholder path
author: Left Diary
    ...
    <main class="row s-styles">
        <section id="styles" class="column large-full">
                ...
                <div class="column large-full">
                    <div class="media-wrap entry__media" id="top">
                        <div style="text-align: center;" class="entry__post-thumb">
                            <img src="{{ site.baseurl }}/assets/images/cover_pages/best-feminist-books-guide.jpg" alt="A collection of books representing feminist literature">
                        </div>
                    </div>
            ...
            <div class="entry__content">
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=Feminism+Is+for+Everybody+Passionate+Politics+bell+hooks&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=The+Feminine+Mystique+Betty+Friedan&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=Ain%27t+I+a+Woman%3F+Black+Women+and+Feminism+bell+hooks&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=Hood+Feminism+Mikki+Kendall&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=Bad+Feminist+Roxane+Gay&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=Sister+Outsider+Audre+Lorde&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=Black+Feminist+Thought+Patricia+Hill+Collins&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=We+Should+All+Be+Feminists+Chimamanda+Ngozi+Adichie&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=The+Beauty+Myth+Naomi+Wolf&tag=bestbooks88-20" %}
                ...
                {% assign book_amazon_link = "https://www.amazon.com/s?k=Invisible+Women+Data+Bias+Caroline+Criado+Perez&tag=bestbooks88-20" %}
